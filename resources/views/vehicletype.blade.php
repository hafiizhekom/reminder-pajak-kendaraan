    ...
    <div id="toolbar">
        <div class="form-inline" role="form">
            <div class="form-group">
                <button class="btn btn-primary" data-toggle="modal" data-target="#addModal">Add Vehicle Type</button>
            </div>
        </div>
    </div>
    ...
    <div id="addModal" class="modal" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{url('/vehicle/type/create')}}" method="POST">
                @csrf
    ...
    <div id="editModal" class="modal" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{url('/vehicle/type/edit')}}" method="POST">
                @csrf
                    <div class="modal-header">
    ...
    <div id="deleteModal" class="modal" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{url('/vehicle/type/delete')}}" method="POST">
                @csrf
                    <div class="modal-header">
